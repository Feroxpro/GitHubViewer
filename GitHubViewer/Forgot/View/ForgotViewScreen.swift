...
protocol ForgotProtocol: AnyObject {
    func actionForgotButton()
}

class ForgotViewScreen: UIView {
        
        weak var delegate:ForgotProtocol?
        func delegate(delegate:ForgotProtocol?){
    ...
    //        view.layer.cornerRadius = 6
        ...
        func setupConstraints() {
            ...
            loginButton.snp.makeConstraints { make in
                make.centerX.equalToSuperview()
                make.top.equalTo(userTextField.snp.bottom).offset(200)
